...
puthlp "PRIVMSG $nick : "
puthlp "PRIVMSG $nick :$notd (azza.id)"
return 0
}
set firsttime "T"
...
if {$mhost == "@azza.id" || [string match "*azza.id" $mhost]} {
putsrv "AWAY"
}
if {![isop $botnick $chan]} { 
if {[info exists invme($mhost)]} {
...
if {![string match "*azza.id*" [string tolower $rest]]} {
